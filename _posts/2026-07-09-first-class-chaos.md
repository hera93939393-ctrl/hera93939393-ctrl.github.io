...
<strong>(회의개요, 참석자, 안건, 주요발언, 결정사항, 후속조치로 나눠줘)</strong></p>
    </div>
  </div>
  <div class="step-item">
...
<strong>(중복된 의견, 공통된 문제, 찬반 입장 찾기)</strong></p>
    </div>
  </div>
  <div class="step-item">
...
<strong>(인사말이나 반복 발언 등 불필요한 내용은 제외하고, 핵심 쟁점과 결론만)</strong></p>
    </div>
  </div>
  <div class="step-item">
...
<strong>(녹취확인 → 안건별 분류 → 핵심의견 요약 → 결정사항 정리 → 담당자 확인 순서로)</strong></p>
    </div>
  </div>
</div>
